...
const STEPS: { Icon: typeof Layers; title: string; body: string }[] = [
  {
    ...
    body: "Pull in your tower's L1 → L4 activities, or load the sample to start from a baseline.",
  },
  {
    Icon: ClipboardList,
  ...
  },
  {
    ...
    body: "Per L4: how much can move offshore, how much AI displaces. Re-seed defaults any time.",
  },
];
