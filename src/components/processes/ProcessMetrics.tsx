...
export function ProcessMetrics({ process }: { process: Process }) {
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <MetricPill label="Time savings" value={`${process.estimatedTimeSavingsPercent}%`} />
      <MetricPill label="Annual hours saved" value={`${formatHours(process.estimatedAnnualHoursSaved)} hrs`} />
