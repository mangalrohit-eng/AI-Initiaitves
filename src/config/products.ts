...
const ALL_PRODUCTS: ForgeProduct[] = [
  {
    id: "capability-assess",
    name: "Tower Capability Map & Opportunity Sizing",
    navLabel: "Capability Map",
    tagline: "Per tower: confirm the L1-L4 map, set offshore and AI dials, and see where modeled value lands.",
    shortDescription:
      "For each functional tower, confirm the capability map, enter the workforce footprint, and dial in offshore + AI levers. Roll up to a scenario summary that shows where the OpEx reduction is concentrated.",
    path: "/assess",
    iconId: "map",
    order: 10,
    audience: "both",
  ...
  },
  {
    id: "delivery-plan",
    name: "Delivery Plan",
    navLabel: "Delivery Plan",
    tagline: "The end-to-end Accenture delivery plan: scope, sequencing, effort, value tracking.",
    shortDescription:
      "The investment case Accenture brings to Versant leadership: scope per tower, sequencing across waves, effort, run-rate cost, value tracking, and the governance to make the OpEx and revenue commitments stick.",
    path: "/delivery-plan",
    ...
    comingSoonLabel: "Planned",
    comingSoonBullets: [
      "Per-tower scope and sequencing across the 0-6 / 6-12 / 12-24 horizons.",
      "Effort and run-rate cost translated from the modeled levers in Capability Map.",
      "Value-tracking framework against the $2.43B adj. EBITDA and $0.375 dividend commitments.",
