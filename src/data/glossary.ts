...
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    ...
    long: "Level-3 capability. The grain captured in the workshop — headcount lives here and the offshore + AI dials are applied here. Example: 'Sourcing & Screening' inside 'Talent Acquisition'.",
  },
  {
    id: "l4",
    category: "Operating model",
    ...
    long: "Level-4 activities are the concrete tasks under each L3 capability. They're shown for context (so leads see what an L3 contains) but the workshop math runs at L3 — L4 lists are seeded from the canonical map or generated by the LLM after upload.",
  },
  {
    id: "capability-map",
    category: "Operating model",
    ...
    long: "Capability maps are authored once per tower at L1-L3 grain and serve as the canonical structure the workshop dials and AI initiatives are scored against. L4 activity lists hang under each L3 for reference and don't drive the math.",
  },
  {
    id: "fte",
    category: "Operating model",
  ...
  },
  {
    ...
    long: "All $ figures in this portal are workshop modelling, not a system of record. They use the user-entered blended rates and the per-L3 dials. Use them to compare towers and prioritise, not to commit.",
  },
  {
    id: "baseline",
    category: "Prioritisation & delivery",
  ...
  },
  {
    ...
    long: "Scenarios let you push the dials beyond the workshop baseline (for executive what-ifs) without overwriting the per-L3 inputs.",
  },
  {
    id: "priority-tier",
    category: "Prioritisation & delivery",
